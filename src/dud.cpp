...
// int gpsFrequency = 2;              // GPS Frequency in Minutes *** USER CONFIG ***
// int gpsHdop = 5;                    // GPS HDOP *** USER CONFIG ***
// int sleepCounter = 0;               // Sleep Counter for live traccking mode

// // GSM Control Variables //
// int transmissionFrequency = 10;     // Transmission Frequency in MINS
...
//   // // digitalWrite(IANT, LOW);
//   // // digitalWrite(GANT, HIGH);
//   // // delay(10000);
//   // // digitalWrite(GANT,LOW);
//   // // digitalWrite(IANT, HIGH);
//   // // delay(10000);
